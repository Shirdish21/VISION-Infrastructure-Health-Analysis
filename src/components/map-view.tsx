...
import { AlertTriangle, MapPin, Zap, Database, Construction } from "lucide-react";
      ...
      {unmappedCount > 0 && (
        <Alert variant="destructive" className="animate-in-fade bg-rose-500/10 border-rose-500/20 text-rose-600">
          ...
          <AlertDescription className="text-xs">
            There are {unmappedCount} infrastructure assets registered without precise geographic coordinates.
          </AlertDescription>
        </Alert>
      )}
      ...
      <Card className="w-full h-[650px] overflow-hidden border-none shadow-2xl ring-1 ring-border rounded-xl animate-in-fade relative z-0">
        ...
        <div className="absolute bottom-6 left-6 z-[1000] bg-background/90 backdrop-blur-md p-5 rounded-xl border shadow-2xl flex flex-col gap-4 pointer-events-none sm:pointer-events-auto border-primary/20">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[11px] font-bold">Standard (40-80%)</span>
          </div>
          <div className="flex items-center gap-3">
          ...
          <div className="pt-2 border-t flex flex-col gap-2">
            <div className="flex items-center gap-3 opacity-80">
              ...
              <span className="text-[10px] font-bold uppercase">Electric Grid Asset</span>
            </div>
            <div className="flex items-center gap-3 opacity-80">
              <Construction className="h-3.5 w-3.5 text-blue-500" />
              <span className="text-[10px] font-bold uppercase">Civil Infrastructure</span>
            </div>
          </div>
        </div>
      </Card>
